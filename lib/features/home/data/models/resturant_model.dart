...
List<Resturant> resturantModelFromJson(String str) =>
    List<Resturant>.from(json.decode(str).map((x) => Resturant.fromJson(x)));

String resturantModelToJson(List<Resturant> data) =>
